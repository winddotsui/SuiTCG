...
os.makedirs("move/sources", exist_ok=True)

contract = """module wave_tcg::marketplace {
...
with open("move/sources/wave_tcg.move", "w") as f:
    f.write(contract)

print("✅ Done! Contract written to move/sources/wave_tcg.move")
