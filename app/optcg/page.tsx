      ...
      <div style={{ background: "#050510", border: "1px solid rgba(255,180,0,0.3)", borderRadius: "20px", padding: "32px", width: "100%", maxWidth: "420px", position: "relative" }}>
        ...
        {step === "confirm" && (
          <>
            <div style={{ textAlign: "center", marginBottom: "28px" }}>
              ...
              <p style={{ fontSize: "13px", color: "#666680" }}>WaveTCG Weekly OPTCG Tournament</p>
            </div>
        ...
        {step === "paying" && (
          <div style={{ textAlign: "center", padding: "20px 0" }}>
            ...
            <p style={{ fontSize: "13px", color: "#666680" }}>Sending 10 SUI to tournament escrow...</p>
          </div>
        )}
        {step === "success" && (
          <div style={{ textAlign: "center", padding: "20px 0" }}>
    ...
    <div style={{ minHeight: "100vh", background: "#000000" }}>
      ...
      {showSimulator && (
        <div style={{ position: "fixed", inset: 0, zIndex: 1000, background: "rgba(0,0,0,0.9)", backdropFilter: "blur(8px)", display: "flex", alignItems: "center", justifyContent: "center", padding: "20px" }}>
          <div style={{ background: "#050510", border: "1px solid rgba(255,50,50,0.3)", borderRadius: "16px", width: "100%", maxWidth: "500px" }}>
      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "40px 24px" }}>
        <div style={{ display: "flex", gap: "4px", borderBottom: "1px solid rgba(255,255,255,0.06)", marginBottom: "32px" }}>
          {[
            ...
            <button key={tab.id} onClick={() => setActiveTab(tab.id)} style={{ padding: "12px 24px", background: "transparent", border: "none", borderBottom: activeTab === tab.id ? "2px solid #ff3333" : "2px solid transparent", color: activeTab === tab.id ? "#ff6b6b" : "#666680", fontSize: "13px", cursor: "pointer", fontFamily: "DM Sans, sans-serif", marginBottom: "-1px" }}>{tab.label}</button>
          ))}
        </div>
        ...
        {activeTab === "tournament" && (
          <div style={{ display: "grid", gridTemplateColumns: "1fr 380px", gap: "32px", alignItems: "start" }}>
            <div>
              ...
              <div style={{ background: "#050510", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "12px", padding: "24px", marginBottom: "24px" }}>
                ...
                {[
                  ...
                  <div key={i} style={{ display: "flex", gap: "10px", padding: "8px 0", borderBottom: i < 7 ? "1px solid rgba(255,255,255,0.05)" : "none" }}>
                    ...
                    <span style={{ fontSize: "13px", color: "#666680", lineHeight: 1.6 }}>{r.rule}</span>
                  </div>
                ))}
              </div>
            ...
            <div style={{ position: "sticky", top: "80px" }}>
              ...
              <div style={{ marginTop: "20px", background: "#050510", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "12px", padding: "16px" }}>
        ...
        {activeTab === "participants" && (
          <div>
            ...
            <div style={{ background: "#050510", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "12px", overflow: "hidden" }}>
              <div style={{ display: "grid", gridTemplateColumns: "60px 1fr 1fr 120px 140px", padding: "16px 24px", borderBottom: "1px solid rgba(255,255,255,0.06)", fontSize: "11px", letterSpacing: "0.1em", textTransform: "uppercase", color: "#444460" }}>
                <div>#</div>
                <div>Player</div>
                <div>Deck</div>
              ...
              {RANKINGS.map((player, i) => (
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                    ...
                    <span style={{ fontFamily: "Cinzel, serif", fontSize: "13px", color: "#666680" }}>#{player.rank}</span>
                  </div>
                  ...
                  <div style={{ textAlign: "center", fontSize: "12px" }}>
                    <span style={{ color: "#4caf7d" }}>{player.wins}W</span><span style={{ color: "#444460" }}> · </span><span style={{ color: "#e05555" }}>{player.losses}L</span>
                  </div>
                  ...
                  <div style={{ textAlign: "right", fontSize: "12px", color: player.change.startsWith("+") ? "#4caf7d" : player.change === "0" ? "#666680" : "#e05555" }}>{player.change === "0" ? "—" : player.change}</div>
                </div>
              ))}
            </div>
          </div>
              ...
              {[
                ...
                <div key={i} style={{ display: "flex", gap: "16px", alignItems: "flex-start", background: "#050510", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "12px", padding: "20px" }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: "14px", color: "#666680", lineHeight: 1.75 }}>{s.desc}</p>
                  </div>
                </div>
              ))}
            </div>
