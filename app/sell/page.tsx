...
function SellContent() {
  ...
  async function uploadImage(): Promise<string> {
    ...
    try {
      const WALRUS_PUBLISHER = process.env.NEXT_PUBLIC_WALRUS_PUBLISHER || "https://publisher.walrus.space";
      const WALRUS_AGGREGATOR = process.env.NEXT_PUBLIC_WALRUS_AGGREGATOR || "https://aggregator.walrus.space";
