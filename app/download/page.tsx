  ...
  return (
    <div style={{ minHeight: "100vh", background: "#000000" }}>
      <div style={{ background: "linear-gradient(180deg, #000000 0%, #000510 50%, #000000 100%)", padding: "60px 48px 40px", borderBottom: "1px solid rgba(255,255,255,0.06)", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <h1 style={{ fontFamily: "Cinzel, serif", fontSize: "clamp(32px, 5vw, 56px)", fontWeight: 900, color: "#ffffff", marginBottom: "16px" }} style={{ background: "linear-gradient(135deg, #0050ff, #00d4ff, #ffffff)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>Download and Play Guide</h1>
