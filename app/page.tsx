  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a0f" }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", textAlign: "center" }}>
          <div style={{
            fontSize: "11px", letterSpacing: "0.2em",
            textTransform: "uppercase", color: "#4da2ff", marginBottom: "16px",
          }}>Multi-Chain Support</div>
          <h2 style={{
            fontFamily: "Cinzel, serif", fontSize: "clamp(28px, 4vw, 48px)",
            fontWeight: 600, color: "#e6e4f0", marginBottom: "48px",
          }}>Trade on any blockchain</h2>
          <div style={{ display: "flex", gap: "20px", justifyContent: "center", flexWrap: "wrap" }}>
            {[
              ...
              <div key={i} style={{
                ...
                <div style={{ fontSize: "11px", color: chain.status === "Live" ? "#4da2ff" : "#555562", letterSpacing: "0.06em" }}>{chain.status}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{
        ...
        }}>Ready to ride the wave?</h2>
        <p style={{
          fontSize: "16px", color: "#888898",
          marginBottom: "40px", fontWeight: 300,
        }}>Join thousands of collectors on WaveTCG.</p>
