  ...
  useEffect(() => {
    async function handleCallback() {
      ...
      if (errorParam) {
        ...
        setStatus("LinkedIn connection failed.");
        return;
      }
      ...
      setStatus("Connected as " + name + "! Redirecting...");
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a0f", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ textAlign: "center", maxWidth: "600px", padding: "24px" }}>
        ...
        {error && (
          <div style={{ background: "rgba(224,85,85,0.1)", border: "1px solid rgba(224,85,85,0.3)", borderRadius: "8px", padding: "12px", fontSize: "12px", color: "#e05555", marginBottom: "16px", wordBreak: "break-all" }}>
            {error}
          </div>
        )}
        {error && (
