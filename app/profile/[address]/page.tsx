      ...
      <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "0 24px" }}>
        <div style={{ display: "flex", gap: "24px", alignItems: "flex-end", marginTop: "16px", marginBottom: "32px", flexWrap: "wrap" }}>
          ...
          <div style={{ position: "relative", flexShrink: 0 }}>
            ...
            <div style={{ position: "absolute", bottom: 0, right: 0, width: "26px", height: "26px", borderRadius: "50%", background: "#050510", border: "2px solid #0078ff", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "12px", cursor: "pointer" }}
          ...
          <div style={{ flex: 1, paddingBottom: "8px" }}>
            ...
            <div style={{ fontSize: "13px", color: "#444460", fontFamily: "monospace", marginBottom: "8px" }}>{address}</div>
            {profile?.bio && <p style={{ fontSize: "14px", color: "#666680", lineHeight: 1.6, marginBottom: "10px" }}>{profile.bio}</p>}
            ...
            <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
              ...
              {!profile?.twitter && !profile?.discord && !profile?.telegram && (
                <button onClick={() => setEditing(true)} style={{ display: "flex", alignItems: "center", gap: "6px", padding: "5px 12px", background: "transparent", border: "1px dashed rgba(255,255,255,0.15)", borderRadius: "20px", fontSize: "12px", color: "#444460", cursor: "pointer", fontFamily: "DM Sans, sans-serif" }}>
                  + Connect Socials
                </button>
              )}
            </div>
          ...
          <button onClick={() => setEditing(!editing)} style={{ padding: "10px 20px", background: "transparent", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "8px", color: "#666680", fontSize: "13px", cursor: "pointer", fontFamily: "DM Sans, sans-serif" }}>Edit Profile</button>
        </div>
        ...
        {editing && (
          <div style={{ background: "#050510", border: "1px solid rgba(68,0,255,0.2)", borderRadius: "16px", padding: "24px", marginBottom: "32px" }}>
            ...
            <div style={{ marginBottom: "20px" }}>
              <label style={{ display: "block", fontSize: "11px", letterSpacing: "0.08em", textTransform: "uppercase", color: "#666680", marginBottom: "8px" }}>Username</label>
              <input value={form.username} onChange={e => setForm(prev => ({ ...prev, username: e.target.value }))} placeholder="e.g. TrainerRed"
                style={{ width: "100%", background: "#0a0a18", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "8px", padding: "10px 14px", fontSize: "14px", color: "#ffffff", fontFamily: "DM Sans, sans-serif", outline: "none", boxSizing: "border-box" }} />
            </div>

            <div style={{ marginBottom: "20px" }}>
              <label style={{ display: "block", fontSize: "11px", letterSpacing: "0.08em", textTransform: "uppercase", color: "#666680", marginBottom: "8px" }}>Bio</label>
              <textarea value={form.bio} onChange={e => setForm(prev => ({ ...prev, bio: e.target.value }))} placeholder="Tell buyers about yourself..." rows={3}
                style={{ width: "100%", background: "#0a0a18", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "8px", padding: "10px 14px", fontSize: "14px", color: "#ffffff", fontFamily: "DM Sans, sans-serif", outline: "none", resize: "vertical", boxSizing: "border-box" }} />
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "12px", marginBottom: "20px" }}>
              {/* Twitter */}
              <div style={{ background: "#0a0a18", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "12px", padding: "16px" }}>
                ...
                <input value={form.twitter} onChange={e => setForm(prev => ({ ...prev, twitter: e.target.value }))} placeholder="username (no @)"
                  style={{ width: "100%", background: "#000000", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "6px", padding: "8px 10px", fontSize: "13px", color: "#ffffff", fontFamily: "DM Sans, sans-serif", outline: "none", boxSizing: "border-box" }} />
                {form.twitter && <div style={{ fontSize: "11px", color: "#4caf7d", marginTop: "6px" }}>twitter.com/{form.twitter}</div>}
              </div>

              {/* Discord */}
              <div style={{ background: "#0a0a18", border: "1px solid rgba(88,101,242,0.2)", borderRadius: "12px", padding: "16px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "10px" }}>
                ...
                <input value={form.discord} onChange={e => setForm(prev => ({ ...prev, discord: e.target.value }))} placeholder="username#1234"
                  style={{ width: "100%", background: "#000000", border: "1px solid rgba(88,101,242,0.2)", borderRadius: "6px", padding: "8px 10px", fontSize: "13px", color: "#ffffff", fontFamily: "DM Sans, sans-serif", outline: "none", boxSizing: "border-box" }} />
                {form.discord && <div style={{ fontSize: "11px", color: "#4caf7d", marginTop: "6px" }}>Connected!</div>}
              </div>

              {/* Telegram */}
              <div style={{ background: "#0a0a18", border: "1px solid rgba(0,136,204,0.2)", borderRadius: "12px", padding: "16px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "10px" }}>
                ...
                <input value={form.telegram} onChange={e => setForm(prev => ({ ...prev, telegram: e.target.value }))} placeholder="username (no @)"
                  style={{ width: "100%", background: "#000000", border: "1px solid rgba(0,136,204,0.2)", borderRadius: "6px", padding: "8px 10px", fontSize: "13px", color: "#ffffff", fontFamily: "DM Sans, sans-serif", outline: "none", boxSizing: "border-box" }} />
                {form.telegram && <div style={{ fontSize: "11px", color: "#4caf7d", marginTop: "6px" }}>t.me/{form.telegram}</div>}
              </div>

              {/* LinkedIn */}
              <div style={{ background: "#0a0a18", border: "1px solid rgba(0,119,181,0.2)", borderRadius: "12px", padding: "16px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "10px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "12px", marginBottom: "40px" }}>
          {[
            ...
            <div key={i} style={{ background: "#050510", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "12px", padding: "16px", textAlign: "center" }}>
              ...
              <div style={{ fontFamily: "Cinzel, serif", fontSize: "22px", fontWeight: 600, color: "#0078ff", marginBottom: "4px" }}>{stat.val}</div>
              <div style={{ fontSize: "11px", color: "#666680", textTransform: "uppercase", letterSpacing: "0.06em" }}>{stat.label}</div>
            </div>
          ))}
        </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(180px, 1fr))", gap: "14px" }}>
              {listings.map(card => (
                <a key={card.id} href={`/card/${card.id}`} style={{ textDecoration: "none" }}>
                  <div style={{ background: "#050510", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "12px", overflow: "hidden", cursor: "pointer", transition: "transform 0.2s" }}
                    onMouseEnter={e => (e.currentTarget as HTMLDivElement).style.transform = "translateY(-4px)"}
                    onMouseLeave={e => (e.currentTarget as HTMLDivElement).style.transform = "translateY(0)"}
                  >
                    <div style={{ width: "100%", aspectRatio: "3/2", background: "#0a0a18", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "40px", overflow: "hidden" }}>
